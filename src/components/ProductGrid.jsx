      ...
      {!showAll && (
        <div className="mt-8 flex justify-center">
          <button
            ...
            className="px-8 py-3 bg-amber-500 dark:bg-amber-600 text-white rounded-lg hover:scale-105 transition-all duration-200 hover:bg-amber-600 dark:hover:bg-amber-700 hover:shadow-lg hover:shadow-amber-300/40 dark:hover:shadow-amber-500/30 font-bold text-lg"
          >
