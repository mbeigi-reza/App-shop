...
const AuthForm = () => {
  ...
  return (
    <div className="min-h-screen flex items-center justify-center bg-gradient-to-r from-amber-50 to-amber-100 dark:from-gray-900 dark:to-gray-800 p-4">
      <ToastContainer />
      <div className="bg-white dark:bg-gray-800 w-full max-w-md p-8 rounded-xl shadow-lg border border-amber-200 dark:border-gray-700">
        {step === 1 ? (
          <>
          ...
          <>
            ...
            <p className="mt-4 text-center text-gray-600 dark:text-gray-400">
              فراموشی رمز عبور؟{" "}
              <span className="text-amber-600 dark:text-amber-400 cursor-pointer hover:underline font-medium">
                کلیک کنید
              </span>
            </p>
