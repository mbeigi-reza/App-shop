...
// ایمپورت تمام تصاویر اسکیت روی یخ
...
// آرایه تمام تصاویر
const iceSkateImages = [
  iceSkate1, iceSkate2, iceSkate3, iceSkate4, iceSkate5,
  iceSkate6, iceSkate7, iceSkate8, iceSkate9, iceSkate10
];

// محصولات اسکیت روی یخ
const iceSkateProducts = [
  {
    id: 1,
    title: "اسکیت روی یخ حرفه‌ای مدل Pro",
    price: 920000,
  },
  {
    id: 2,
    title: "اسکیت روی یخ فیکس",
    price: 680000,
  },
  {
    id: 3,
  ...
  {
    id: 5,
    title: "اسکیت روی یخ تفریحی",
    price: 550000,
  },
  {
    id: 6,
    title: "اسکیت روی یخ کودک",
    price: 450000,
  },
  {
    id: 7,
  ...
  {
    id: 9,
    title: "اسکیت روی یخ قابل تنظیم",
    price: 720000,
  },
  {
    id: 10,
    title: "اسکیت روی یخ مبتدی",
    price: 480000,
  },
];
...
const IceSkates = () => {
  const {
    ...
    clearFilters,
    getButtonText
  } = usePriceFilter(iceSkateProducts, 4);
    ...
    <div className="bg-white dark:bg-gray-900 min-h-screen text-gray-800 dark:text-white relative overflow-hidden">
      <div className="max-w-7xl mx-auto px-4 py-4 lg:py-12 flex flex-col lg:flex-row gap-8">
        ...
        <div className="flex-1">
          ...
          <RandomImageManager images={iceSkateImages} productCount={filteredProducts.length}>
            {(currentImages) => (
              <>
                {/* کارت‌های محصولات */}
